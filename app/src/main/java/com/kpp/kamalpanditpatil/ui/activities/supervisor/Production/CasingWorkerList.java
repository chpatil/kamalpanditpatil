...
public class CasingWorkerList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_casing_worker_list);
        Toolbar toolbar = findViewById(R.id.casingworkerListToolbar);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, constants.CASINGWORKERLIST, new Response.Listener<String>() {
            @Override
...
//
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                CasingWorkerList.this.adapter.getFilter().filter(cs);
            }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent = new Intent(CasingWorkerList.this, CasingWorkerwiseProduction.class);
    ...
    private void dispalyAlert(String Message) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(CasingWorkerList.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(this, CasingActivity.class));
        finish();
    }
}