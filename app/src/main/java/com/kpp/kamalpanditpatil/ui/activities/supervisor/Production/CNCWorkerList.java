...
public class CNCWorkerList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cncworker_list);
        Toolbar toolbar = findViewById(R.id.cncworkerListToolbar);
        toolbar.setTitle("CNC WORKERS");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, constants.CNCWORKERLIST, new Response.Listener<String>() {
            @Override
...
//
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                CNCWorkerList.this.adapter.getFilter().filter(cs);
            }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent = new Intent(CNCWorkerList.this, CNCWorkerWiseProduction.class);
    ...
    private void dispalyAlert(String Message) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(CNCWorkerList.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(this, CNCActivity.class));
        finish();
    }
}