...
public class AdminAttendanceCNCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("CNC ATTENDANCE");
        ...
        daterange1 = findViewById(R.id.adminAttendanceCNCdaterangeButton1);
        daterange2 = findViewById(R.id.adminAttendanceCNCdaterangeButton2);
        dateButton = findViewById(R.id.adminAttendanceCNCdateButton);
        personwise = findViewById(R.id.adminAttendanceCNCpersonwisewiseButton);
        overtimewise = findViewById(R.id.adminAttendanceCNCOvertimewisewiseButton);
        ...
        datewiseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (date1.before(today1) || date1.equals(today1)) {
                    Intent intent = new Intent(AdminAttendanceCNCActivity.this, AttendanceDatewiseDetailActivity.class);
                    intent.putExtra("department", department);
                    intent.putExtra("date", DatabaseDate);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(AdminAttendanceCNCActivity.this, "Please set after date properly", Toast.LENGTH_SHORT).show();
        ...
        personwise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (DatabaseDaterange1 == null || DatabaseDaterange2 == null) {
                    Toast.makeText(AdminAttendanceCNCActivity.this, "Please set date properly", Toast.LENGTH_SHORT).show();
                } else {
                    try {
                        today1 = sdf.parse(today);
                    ...
                    if (date1.before(date2) && date1.before(today1) && (date2.equals(today1) || date2.before(today1))) {
                        Intent intent = new Intent(AdminAttendanceCNCActivity.this, AttendanceListActivity.class);
                        intent.putExtra("department", department);
        ...
        overtimewise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (DatabaseDaterange1 == null || DatabaseDaterange2 == null) {
                    ...
                    if (date1.before(date2) && date1.before(today1) && (date2.equals(today1) || date2.before(today1))) {
                        Intent intent = new Intent(AdminAttendanceCNCActivity.this, AttendanceOvertimeDetails.class);
                        intent.putExtra("department", department);
