...
public class AttendanceCNCActivity extends AppCompatActivity {
    static final int Dialog_id = 0;
    public final String TAG = "Attendance.cnc.worker_list";
    // Listview Adapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_cnc);
        Toolbar toolbar = findViewById(R.id.attendanceCNCworkerListToolbar);
        toolbar.setTitle("C.N.C WORKERS");
        setSupportActionBar(toolbar);
        final String department = "CNC";
        workerlist = new ArrayList<String>();
        dateButton = findViewById(R.id.AttendanceCNCdateButton);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, constants.ATTENDANCECNCWORKERLIST, new Response.Listener<String>() {
            @Override
...
//
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                AttendanceCNCActivity.this.adapter.getFilter().filter(cs);
            }
    ...
    private void dispalyAlert(String Message) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(AttendanceCNCActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        });
