...
public class AdminAttendanceQandAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datewiseButton = findViewById(R.id.adminAttendanceQandAdatewiseButton);
        datewiseButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AdminAttendanceQandAActivity.this, AttendanceDetailActivity.class);
