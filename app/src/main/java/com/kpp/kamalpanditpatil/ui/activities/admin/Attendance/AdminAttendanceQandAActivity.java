...
public class AdminAttendanceQandAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_attendance_qand_a);
        Toolbar toolbar = findViewById(R.id.adminattendanceQandAworkerToolbar);
        toolbar.setTitle("Q AND A ATTENDANCE");
        ...
        daterange1 = findViewById(R.id.adminAttendanceQandAdaterangeButton1);
        daterange2 = findViewById(R.id.adminAttendanceQandAdaterangeButton2);
        dateButton = findViewById(R.id.adminAttendanceQandAdateButton);
        personwise = findViewById(R.id.adminAttendanceQandApersonwisewiseButton);
        overtimewise = findViewById(R.id.adminAttendanceQandAOvertimewisewiseButton);
        dateButton.setText(Date);
        datewiseButton = findViewById(R.id.adminAttendanceQnandAdatewiseButton);
        datewiseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (date1.before(today1) || date1.equals(today1)) {
                    Intent intent = new Intent(AdminAttendanceQandAActivity.this, AttendanceDatewiseDetailActivity.class);
                    intent.putExtra("department", department);
                    intent.putExtra("date", DatabaseDate);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(AdminAttendanceQandAActivity.this, "Please set after date properly", Toast.LENGTH_SHORT).show();
        ...
        personwise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (DatabaseDaterange1 == null || DatabaseDaterange2 == null) {
                    Toast.makeText(AdminAttendanceQandAActivity.this, "Please set date properly", Toast.LENGTH_SHORT).show();
                } else {
                    try {
                        today1 = sdf.parse(today);
                    ...
                    if (date1.before(date2) && date1.before(today1) && (date2.equals(today1) || date2.before(today1))) {
                        Intent intent = new Intent(AdminAttendanceQandAActivity.this, AttendanceListActivity.class);
                        intent.putExtra("department", department);
        ...
        overtimewise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (DatabaseDaterange1 == null || DatabaseDaterange2 == null) {
                    ...
                    if (date1.before(date2) && date1.before(today1) && (date2.equals(today1) || date2.before(today1))) {
                        Intent intent = new Intent(AdminAttendanceQandAActivity.this, AttendanceOvertimeDetails.class);
                        intent.putExtra("department", department);
