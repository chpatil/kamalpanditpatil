...
public class AdminAttendanceGrindingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_attendance_grinding);
        Toolbar toolbar = findViewById(R.id.adminattendancegrindingworkerToolbar);
        toolbar.setTitle("GRINDING ATTENDANCE");
        ...
        daterange1 = findViewById(R.id.adminAttendanceGrindingdaterangeButton1);
        daterange2 = findViewById(R.id.adminAttendanceGrindingdaterangeButton2);
        dateButton = findViewById(R.id.adminAttendanceGrindingdateButton);
        personwise = findViewById(R.id.adminAttendanceGrindingpersonwisewiseButton);
        overtimewise = findViewById(R.id.adminAttendanceGrindingOvertimewisewiseButton);
        dateButton.setText(Date);
        datewiseButton = findViewById(R.id.adminAttendanceGrindingdatewiseButton);
        datewiseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (date1.before(today1) || date1.equals(today1)) {
                    Intent intent = new Intent(AdminAttendanceGrindingActivity.this, AttendanceDatewiseDetailActivity.class);
                    intent.putExtra("department", department);
                    intent.putExtra("date", DatabaseDate);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(AdminAttendanceGrindingActivity.this, "Please set after date properly", Toast.LENGTH_SHORT).show();
        ...
        personwise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (DatabaseDaterange1 == null || DatabaseDaterange2 == null) {
                    Toast.makeText(AdminAttendanceGrindingActivity.this, "Please set date properly", Toast.LENGTH_SHORT).show();
                } else {
                    try {
                        today1 = sdf.parse(today);
                    ...
                    if (date1.before(date2) && date1.before(today1) && (date2.equals(today1) || date2.before(today1))) {
                        Intent intent = new Intent(AdminAttendanceGrindingActivity.this, AttendanceListActivity.class);
                        intent.putExtra("department", department);
        ...
        overtimewise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (DatabaseDaterange1 == null || DatabaseDaterange2 == null) {
                    ...
                    if (date1.before(date2) && date1.before(today1) && (date2.equals(today1) || date2.before(today1))) {
                        Intent intent = new Intent(AdminAttendanceGrindingActivity.this, AttendanceOvertimeDetails.class);
                        intent.putExtra("department", department);
