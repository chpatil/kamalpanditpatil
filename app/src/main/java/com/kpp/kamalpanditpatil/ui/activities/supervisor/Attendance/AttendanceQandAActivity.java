...
public class AttendanceQandAActivity extends AppCompatActivity {
    static final int Dialog_id = 0;
    public final String TAG = "Attendance.qanda.worker_list";
    // Listview Adapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_qand_a);
        Toolbar toolbar = findViewById(R.id.attendanceqandaworkerListToolbar);
        toolbar.setTitle("Q AND A WORKERS");
        setSupportActionBar(toolbar);
        final String department = constants.QANDA;
        workerlist = new ArrayList<String>();
        dateButton = findViewById(R.id.AttendanceqandadateButton);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, constants.ATTENDANCEQANDAWORKERLIST, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (code.equals("0")) {
                        Toast.makeText(AttendanceQandAActivity.this, "Attendance not submitted", Toast.LENGTH_SHORT).show();
                        pDialog.dismiss();
...
//
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                AttendanceQandAActivity.this.adapter.getFilter().filter(cs);
            }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                prefEditor.putString("department", "QandA");
                prefEditor.putString("databaseDate", DatabaseDate);
                prefEditor.commit();
                attendanceDialog = new AttendanceDialog(AttendanceQandAActivity.this);
    ...
    private void dispalyAlert(String Message) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(AttendanceQandAActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        });
